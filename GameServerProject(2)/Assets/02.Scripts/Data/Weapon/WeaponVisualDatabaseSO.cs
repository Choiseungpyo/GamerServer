...
public class WeaponVisualDatabaseSO : ScriptableObject
{
    [SerializeField] private List<WeaponData> list = new List<WeaponData>();
    private readonly Dictionary<int, WeaponData> byId = new Dictionary<int, WeaponData>();
    ...
    public bool TryGet(int weaponId, out WeaponData row)
    {
